...
function SimpleLib:Create(title, button1Text, button1Callback, button2Text, button2Callback)
    ...
    local gui = newInstance("ScreenGui", player:WaitForChild("PlayerGui"))
    gui.Name = "SimpleLibUI"

    local frame = newInstance("Frame", gui)
    ...
    local closeButton = newInstance("Text".."Button", frame)
    ...
    local button1 = newInstance("Text".."Button", frame)
    ...
    local button2 = newInstance("Text".."Button", frame)
