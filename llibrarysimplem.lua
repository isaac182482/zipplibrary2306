local A,B="dark",{}
local C={
d={background=Color3.fromRGB(35,35,35),header=Color3.fromRGB(25,25,25),button=Color3.fromRGB(55,55,55),text=Color3.new(1,1,1),close=Color3.fromRGB(45,45,45),closeText=Color3.fromRGB(255,80,80)},
p={background=Color3.fromRGB(45,0,75),header=Color3.fromRGB(30,0,50),button=Color3.fromRGB(85,0,125),text=Color3.new(1,1,1),close=Color3.fromRGB(60,0,90),closeText=Color3.fromRGB(255,150,255)}
}
local function n(c,p)return Instance.new(c,p)end
function B:s(a)if C[a]then A=a end end
function B:c(t,b1,f1,b2,f2)local th=C[A]local pl=game.Players.LocalPlayer
